function __InputConfigVerbs()
{
    ...
    if (not INPUT_ON_SWITCH)
    {
        ...
        InputDefineVerb(INPUT_VERB.LEFT,    "left",       [vk_left,  "A", "J"],    [-gp_axislh, gp_padl, gp_shoulderl, gp_shoulderlb]);
        InputDefineVerb(INPUT_VERB.RIGHT,   "right",      [vk_right,  "D", "L"],    [ gp_axislh, gp_padr, gp_shoulderr, gp_shoulderrb]);
		InputDefineVerb(INPUT_VERB.DOWN,    "down",       [vk_down,  "S", "K"],    [gp_axislv, gp_padd]);
        InputDefineVerb(INPUT_VERB.ACCEL,  "accel",      [vk_up,  "W", "I"],            [gp_face3, gp_face3]);
        InputDefineVerb(INPUT_VERB.DASH,  "dash",      vk_space,            [gp_face1, gp_face2]);
        InputDefineVerb(INPUT_VERB.RESTART,  "restart",      ["R", "Y"],        [gp_start, gp_select]);
    }
    else //Flip A/B over on Switch
    {
		InputDefineVerb(INPUT_VERB.DOWN,    "down",       undefined,    [-gp_axislv, gp_padu]);
        ...
        InputDefineVerb(INPUT_VERB.ACCEL,  "accel",      undefined,            [gp_face3, gp_face3]);
        InputDefineVerb(INPUT_VERB.DASH,  "dash",      undefined,            [gp_face1, gp_face2]);
        InputDefineVerb(INPUT_VERB.RESTART,  "restart",      undefined,        [gp_start, gp_select]);
