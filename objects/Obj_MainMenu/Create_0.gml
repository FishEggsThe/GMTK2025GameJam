...
var mainItems = [
	new MenuItem("Play", "GO!!!!!!!!!!!!!!", function(c){ show_debug_message("shart"); }),
...
var optionItems = [
	new MenuItem("Controls", "Toggle between left & right handed controls", 
				 function(c){ with Obj_Control { leftHanded = !leftHanded;} ; }, "W/A/D/Space/R"),
